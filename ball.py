...
IMG_WOOD = pygame.image.load('wood.png')
IMG_BACKGROUND = pygame.image.load('background.png')
IMG_FRAME = pygame.image.load('frame.png')
IMG_THORN = pygame.image.load('thorn.png')
IMG_HEART = pygame.image.load('heart.png')
IMG_BACKBUTTON = pygame.image.load('backButton.png')
IMG_PLAYBUTTON = pygame.image.load('playButton.png')
IMG_REPLAYBUTTON = pygame.image.load('replayButton.png')
IMG_QUITBUTTON = pygame.image.load('quitButton.png')
IMG_HIGHLIGHT = pygame.image.load('highlight.png')
IMG_H_START = pygame.image.load('headingStart.png')
IMG_H_GAMEOVER = pygame.image.load('headingGameover.png')
